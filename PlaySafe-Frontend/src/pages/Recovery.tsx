...
const players = [
  { name: "J. Martinez", recovery: 54, status: "caution", readiness: "Below optimal" },
  { name: "A. Diallo", recovery: 72, status: "moderate", readiness: "Moderate" },
  { name: "L. Chen", recovery: 88, status: "good", readiness: "Match ready" },
  { name: "R. Kim", recovery: 95, status: "good", readiness: "Fully recovered" },
  { name: "M. Santos", recovery: 62, status: "caution", readiness: "Light training only" },
];
    ...
    const ctx = gsap.context(() => {
      ...
      barsRef.current.forEach((el, i) => {
        ...
        gsap.fromTo(el,
          { width: 0 },
          {
            width: `${players[i].recovery}%`, duration: 1.2, ease: "power3.out",
