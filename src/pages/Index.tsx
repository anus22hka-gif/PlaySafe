...
const Index = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      // TODO: connect to backend upload API here
    }
  };
    ...
    <div className="space-y-8 max-w-7xl mx-auto px-6 pt-24 pb-16">
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              FC United vs City Rovers — Feb 9, 2026
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="glass-card rounded-lg px-4 py-2 text-xs font-semibold text-primary hover:scale-105 transition-transform"
            >
              Upload Video
            </button>
      ...
      >
        <StatCard
          ...
          value="42"
          subtitle="Moderate overall"
          icon={AlertTriangle}
          variant="warning"
          trend={{ value: "8% from last match", positive: false }}
        />
        <StatCard
          title="Sprint Load"
          value="347"
          subtitle="Total high-intensity runs"
          icon={Zap}
          variant="primary"
          trend={{ value: "12% increase", positive: true }}
        />
        <StatCard
          title="Deceleration Events"
          value="89"
          subtitle="High-stress braking"
          icon={TrendingUp}
          variant="default"
        />
        <StatCard
          ...
          value="4.2s"
          subtitle="Between sprints"
          icon={Timer}
          variant="default"
          trend={{ value: "0.3s slower", positive: false }}
        />
      </div>
      ...
      >
        ...
        <div className="glass-card rounded-xl p-6" style={{ opacity: 0 }}>
          <h3 className="text-sm font-semibold font-display text-foreground mb-6">
            Player Risk Snapshot
          </h3>
