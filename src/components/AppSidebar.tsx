...
import { Activity, User, Brain, HeartPulse, LayoutDashboard } from "lucide-react";
  ...
  return (
    <aside ref={sidebarRef} className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-border bg-sidebar" style={{ opacity: 0 }}>
      <div ref={logoRef} className="flex items-center gap-3 px-6 py-6">
        ...
        <div>
          <h1 className="text-lg font-bold font-display text-foreground">PlayWise</h1>
          <p className="text-[10px] font-medium uppercase tracking-widest text-primary">AI Intelligence</p>
        </div>
      </div>
